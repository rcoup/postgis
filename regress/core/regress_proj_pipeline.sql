...
SELECT '8', ST_AsText(ST_SnapToGrid(ST_TransformPipeline('SRID=32631;POINT(426857 5427937)'::geometry, 'urn:ogc:def:coordinateOperation:EPSG::16031', FALSE), 0.1));
SELECT '9', ST_SRID(ST_TransformPipeline('SRID=32631;POINT(426857 5427937)'::geometry, 'urn:ogc:def:coordinateOperation:EPSG::16031', FALSE, 12345));
